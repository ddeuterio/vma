...
`vma` documentation uses [Sphinx](https://www.sphinx-doc.org/en/master/) as its main documentation compiler.
...
4. When you're done editing, do:
   ...
   any eventual issues. This should automatically use flake8/black to check/fix the code style
